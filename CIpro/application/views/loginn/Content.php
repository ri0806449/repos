      ...
      ?>
        ...
        <div class="container">
          ...
          <?php 
            ...
            echo form_open('member/loginn/user_login_process',$attributes);
          ?>
          <?php
             ...
             <div class="message">
              ...
              <div class="row">
                <div class="input-field col s12">
                  ...
                  <a href="<?= base_url() ?>index.php/member/forget/forgot_password">忘記密碼？</a>
                </div>
              </div>
              ...
              <br>
              <p style="text-align:left;">新使用者？ <a href="<?= base_url() ?>index.php/member/setting/user_register">請註冊</a></p>
            </form>
          </div>
        </div>
