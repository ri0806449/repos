	...
	<main>
		<div class="row">
			<?php 
            	...
            	echo form_open('user_authentication/forgot_password', $attributes);
			?>
				<fieldset>
					<legend><h5>忘記密碼——填寫註冊email</h5></legend>
				    <div class="input-field col s6">
				      <input id="verify_email" type="text" class="validate" name="verify_email" value="<?= set_value('verify_email'); ?>">
