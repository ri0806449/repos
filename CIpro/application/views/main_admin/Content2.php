		...
		<div class="row">
			...
			<div class="row">
				<div class="col s6">
					<form>
						<div class="col s4">
							搜尋帳號欄：<input type="text" name="search_username_try" placeholder="打點什麼吧～" id="search_username_try">
						</div>
						<div class="col s4">
							搜尋email欄：<input type="text" name="search_email_try" placeholder="打點什麼吧～" id="search_email_try">
						</div>
		 				<button method="GET" class="btn waves-effect waves-light btn-large" type="submit" name="action">送出
